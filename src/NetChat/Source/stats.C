...
MRESULT EXPENTRY STATSDlgProc(HWND hwndDlg, ULONG msg, MPARAM mp1, MPARAM mp2)
{
 ...
 /* ##END Top of window procedure */
   ...
   case WM_INITDLG :
     HandleMessage(hwndFrame, hwndDlg, msg, mp1, mp2);
      ...
      WinSetDlgItemText(hwndDlg, 1000, localIP);
      /* ##END  */
      }
      break;
...
HWND OpenSTATS(HWND hwndOwner, PVOID pInfo)
{
   HWND hwndFrame;
