...
MRESULT EXPENTRY HAILLISTDlgProc(HWND hwndDlg, ULONG msg, MPARAM mp1, MPARAM mp2)
{
 ...
 /* ##END Top of window procedure */
   ...
   case WM_COMMAND :
      if( menuChoice(SHORT1FROMMP(mp1), hwndDlg) )
         break;
      ...
      case 1002:
         {
         /* ##START 1002.0  */
         /* Event Clicked/selected - ~Busy now ...  1002 */

         WinSetDlgItemText(hwndDlg, 1001, "I am busy right now but Hail me again in about  minutes.");
         /* ##END  */
         }
         break;
      ...
      case 1004:
         {
         /* ##START 1004.0  */
         /* Event Clicked/selected - Have to run ...  1004 */

         WinSetDlgItemText(hwndDlg, 1001, "I am busy right now but I will Hail you in about  minutes.");
         /* ##END  */
         }
         break;
      /* Button 1005 Clicked/Selected */
      case 1005:
         {
         /* ##START 1005.0  */
         /* Event Clicked/selected - Hail me on ports ...  1005 */

         WinSetDlgItemText(hwndDlg, 1001, "I will listen for you to connect to this hail for about  minutes.");
         /* ##END  */
         }
         break;
      } /* end switch */
